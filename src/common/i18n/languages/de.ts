...
const lang: LanguageDict = {
  ...
  colon: ': ',
  commands: 'Befehle',
  commands_help: 'Die folgenden Systembefehle werden ausgeführt, wenn Dotfile angewendet werden:',
  commands_title: 'Befehl nach dem Anlegen eines Dotfile',
  ...
  homepage: 'Startseite',
  host: 'Gastgeber',
  dotfile_add: 'Neue Dotfile hinzufügen',
  dotfile_delete: 'Diesen Dotfile löschen',
  dotfile_delete_confirm: 'Sind Sie sicher, dass Sie die aktuellen Dotfile löschen wollen?',
  dotfile_edit: 'Dotfile bearbeiten',
  dotfile_title: 'Titel des Dotfile',
  dotfile_type: 'Dotfile Typ',
  dotfile_updated: 'Die Dotfile-Datei wurde aktualisiert.',
  hour: 'Stunde',
  hours: 'Stunden',
  http_api_on: 'HTTP-API eingeschaltet',
  http_api_on_desc:
    'Läuft auf Port {0}, kann von Software von Drittanbietern wie Alfred verwendet werden, um den Dotfile zu wechseln.',
  ...
  migrate_confirm:
    'SwitchDotfile v4.0 verwendet ein neues Datenspeicherformat, möchten Sie alte Daten in das neue Format migrieren?',
  ...
  next: 'Nächste',
  no_access_to_file: 'Keine Berechtigung zum Schreiben in die Dotfile-Datei.',
  ...
  system_dotfile: 'System-Dotfile',
  system_default_dotfile: 'System-Standard-Dotfile',
  system_default_config: 'System-Standard-Konfiguration',
  system_dotfile_history: 'Historische Versionen der System-Dotfile',
  system_dotfile_history_delete_confirm: 'Sind Sie sicher, dass Sie dieses Element löschen wollen?',
  ...
  system_dotfile_history_limit: 'Maximale Anzahl von Datensätzen: ',
  test: 'Test',
  theme: 'Thema',
  theme_dark: 'Dunkel',
  theme_light: 'Hell',
  ...
  usage_data_help:
    'Möchten Sie uns helfen, SwitchDotfile zu verbessern, indem Sie regelmäßig anonyme Nutzungsdaten übermitteln?',
  usage_data_title: 'Machen Sie SwitchDotfile besser!',
  ...
  where_is_my_dotfile: 'Wo ist meine Dotfile-Datei?',
  window: 'Fenster',
  write_mode: 'Schreibmodus',
  write_mode_append_help:
    'Hängen Sie die neuen Datensätze an das Ende der Dotfile-Datei des Systems an.',
  write_mode_overwrite_help: 'Überschreibt die Systemdotfile-Datei mit den neuen Datensätzen.',
  write_mode_set: 'Schreibmodus einstellen',
  your_data_is: 'Ihre Datendateien sind gespeichert in:',
  your_dotfile_is: 'Ihre Dotfile-Datei befindet sich in:',
  zoom: 'Vergrößern',
  zoom_in: 'Vergrößern',
