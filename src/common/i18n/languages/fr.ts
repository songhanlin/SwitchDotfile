...
const lang: LanguageDict = {
  ...
  colon: ' : ',
  commands: 'Commandes',
  commands_help: 'Les commandes systèmes suivantes seront exécutées quand le dotfile sera activé :',
  commands_title: "Commandes une fois qu'un dotfile est activé",
  ...
  host: 'Host',
  dotfile_add: 'Ajouter un nouveau dotfile',
  dotfile_delete: 'Supprimer ce dotfile',
  dotfile_delete_confirm: 'Êtes-vous sûr de vouloir supprimer ce dotfile?',
  dotfile_edit: "Éditer le dotfile",
  dotfile_title: "Titre du dotfile",
  dotfile_type: "Type de dotfile",
  dotfile_updated: 'Le fichier dotfile a été mis à jour',
  hour: 'heure',
  hours: 'heures',
  http_api_on: 'Activer HTTP API',
  http_api_on_desc:
    "Actif sur le port {0}, peut être utilisé par un logiciel tier comme Alfred pour changer de dotfile",
  ...
  migrate_confirm:
    'SwitchDotfile v4.0 utilise un nouveau format de stockage des données, voulez-vous migrer les anciennes données dans ce nouveau format ?',
  ...
  next: 'Suivant',
  no_access_to_file: 'Aucune autorisation pour écrire dans le fichier dotfile.',
  ...
  system_dotfile: 'Dotfile du système',
  system_default_dotfile: 'Dotfile par défaut du système',
  system_default_config: 'Configuration par défaut du système',
  system_dotfile_history: 'Historique des versions dotfile du système',
  system_dotfile_history_delete_confirm: 'Êtes-vous sûr de vouloir supprimer cet élément ?',
  system_dotfile_history_help:
    "Si le nombre total d'enregistrements dépasse cette limite, l'enregistrement le plus ancien sera supprimé.",
  system_dotfile_history_limit: "Nombre max. d'enregistrements : ",
  test: 'Test',
  theme: 'Thème',
  theme_dark: 'Sombre',
  theme_light: 'Clair',
  ...
  usage_data_help:
    "Voulez-vous nous aider à améliorer SwitchDotfile en soumettant périodiquement vos données d'utilisation de manière anonyme ?",
  usage_data_title: 'Rendez SwitchDotfile meilleur !',
  ...
  where_is_my_dotfile: 'Où est mon fichier dotfile ?',
  window: 'Fenêtre',
  write_mode: "Mode d'écriture",
  write_mode_append_help:
    "Ajoutez les nouveaux enregistrements à la fin du fichier dotfile système.",
  write_mode_overwrite_help:
    "Écrasez le fichier dotfile système avec les nouveaux enregistrements.",
  write_mode_set: "Définir le mode d'écriture",
  your_data_is: 'Les fichiers contenant vos données sont stockés ici :',
  your_dotfile_is: 'Votre fichier dotfile est situé ici :',
  zoom: 'Zoom',
  zoom_in: 'Zoommer',
  zoom_out: 'Dézoommer',
}
