...
export default {
  ...
  commands: '명령어',
  commands_help:
    'dotfile을 적용하면 시스템에 명령어가 실행됩니다:',
  commands_title: 'dotfile이 적용된 후 명령어',
  ...
  homepage: '홈페이지',
  host: '호스트',
  dotfile_add: '새로운 dotfile 추가',
  dotfile_delete: '이 dotfile 삭제',
  dotfile_delete_confirm: '현재 dotfile을 삭제하시겠습니까?',
  dotfile_edit: 'dotfile 수정',
  dotfile_title: 'dotfile 제목',
  dotfile_type: 'dotfile 유형',
  dotfile_updated: 'dotfile 파일이 갱신되었습니다.',
  hour: '시간',
  hours: '시간',
  http_api_on: 'HTTP API 사용',
  http_api_on_desc:
    '포트 {0}에서 실행되며, Alfred와 같은 서드파티 소프트웨어를 통해 dotfile을 전환하는데 사용할 수 있습니다.',
  ...
  match: '일치',
  migrate_confirm:
    'SwitchDotfile v4.0는 새로운 데이터 저장 형식을 사용합니다. 이전 데이터를 새 형식으로 마이그레이션(이전)하시겠습니까?',
  migrate_data: '데이터 이전',
  minimize: '최소화',
  minute: '분',
  minutes: '분',
  ...
  next: '다음',
  no_access_to_file: 'dotfile 파일 쓰기 권한이 없습니다.',
  no_record: '레코드 없음',
  overwrite: '덮어쓰기',
  password: '패스워드',
  paste: '붙여넣기',
  ...
  system_dotfile: '시스템 dotfile',
  system_default_dotfile: '시스템 기본 dotfile',
  system_default_config: '시스템 기본 설정',
  system_dotfile_history: '시스템 dotfile의 이력버전',
  system_dotfile_history_delete_confirm:
    '이 항목을 삭제하시겠습니까?',
  system_dotfile_history_help:
    '이력 개수가 이 제한을 초과하면 가장 오래된 이력부터 삭제됩니다.',
  system_dotfile_history_limit: '이력 최대 개수: ',
  test: '테스트',
  theme: '테마',
  theme_dark: '다크',
  theme_light: '라이트',
  ...
  where_is_my_dotfile: '내 dotfile 파일은 어디에 있나요?',
  window: '창',
  write_mode: '쓰기 모드',
  write_mode_append_help:
    '시스템 dotfile 파일 마지막 줄에 새 레코드를 추가합니다.',
  write_mode_overwrite_help:
    '시스템 dotfile 파일에 새 레코드로 덮어씁니다.',
  write_mode_set: '쓰기 모드 설정',
  your_data_is: '데이터 저장 위치:',
  your_dotfile_is: 'dotfile 파일 위치:',
  zoom: '확대',
  zoom_in: '확대',
  zoom_out: '축소',
}
