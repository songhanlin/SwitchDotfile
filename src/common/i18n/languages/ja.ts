...
const lang: LanguageDict = {
  ...
  choice_mode_desc:
    '最上位階層のdotfileにのみ有効で、各フォルダーでは独自に選択モードを設定できます。',
  ...
  colon: ': ',
  commands: 'コマンド',
  commands_help: 'dotfileが適用されたとき、以下のシステムコマンドを実行します:',
  commands_title: 'dotfile適用後のコマンド',
  ...
  homepage: 'ホームページ',
  host: 'ホスト',
  dotfile_add: 'dotfileを追加',
  dotfile_delete: 'dotfileを削除',
  dotfile_delete_confirm: 'このdotfileを削除してもよろしいですか？',
  dotfile_edit: 'dotfileを編集',
  dotfile_title: 'dotfileタイトル',
  dotfile_type: 'dotfileタイプ',
  dotfile_updated: 'dotfileを更新しました。',
  hour: '時間',
  hours: '時間',
  http_api_on: 'HTTP APIを有効化',
  http_api_on_desc:
    '{0}番ポートで実行され、Alfredなどのサードパーティソフトウェアでdotfileを切り替えるために使用できます。',
  ...
  match: '一致',
  migrate_confirm:
    'SwitchDotfile v4.0は新しいデータ保存形式を使用します。古いデータを新しい形式に移行しますか？',
  migrate_data: 'データ移行',
  minimize: '最小化',
  minute: '分',
  minutes: '分',
  ...
  next: '次へ',
  no_access_to_file: 'dotfileファイルの書き込み権限がありません。',
  no_record: 'なし',
  overwrite: '上書き',
  password: 'パスワード',
  paste: '貼り付け',
  ...
  system_dotfile: 'システムdotfile',
  system_default_dotfile: 'システムデフォルトのdotfile',
  system_default_config: 'システムデフォルト設定',
  system_dotfile_history: 'システムdotfileのバージョン履歴',
  system_dotfile_history_delete_confirm: 'この履歴を削除してもよろしいですか？',
  system_dotfile_history_help: '履歴件数がこれを超えると、最も古い履歴が削除されます。',
  system_dotfile_history_limit: '履歴の最大件数: ',
  test: 'テスト',
  theme: 'テーマ',
  theme_dark: 'ダーク',
  theme_light: 'ライト',
  ...
  where_is_my_dotfile: 'dotfileファイルはどこにありますか？',
  window: 'ウィンドウ',
  write_mode: '書き込みモード',
  write_mode_append_help: '新しいレコードをシステムdotfileの末尾に追記します。',
  write_mode_overwrite_help: '新しいレコードでシステムdotfileを上書きします。',
  write_mode_set: '書き込みモードを設定',
  your_data_is: 'あなたのデータファイルはこちらに保存されています:',
  your_dotfile_is: 'あなたのdotfileファイルはこちらにあります:',
  zoom: 'ズーム',
  zoom_in: '拡大',
  zoom_out: '縮小',
}
