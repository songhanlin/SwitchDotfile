...
export default {
  ...
  colon: ': ',
  commands: 'Komutlar',
  commands_help: 'Dotfile uygulandığında aşağıdaki sistem komutları çalıştırılacaktır:',
  commands_title: 'Dotfile uygulandıktan sonra komut',
  ...
  homepage: 'Anasayfa',
  host: 'Host',
  dotfile_add: 'Yeni dotfile ekle',
  dotfile_delete: 'Bu dotfile sil',
  dotfile_delete_confirm: 'Mevcut dotfile silmek istediğinizden emin misiniz?',
  dotfile_edit: 'Dotfile düzenle',
  dotfile_title: 'Dotfile Başlığı',
  dotfile_type: 'Dotfile Türü',
  dotfile_updated: 'Dotfile dosyası güncellendi.',
  hour: 'saat',
  hours: 'saatler',
  ...
  match: 'Eşleşme',
  migrate_confirm:
    'SwitchDotfile v4.0 yeni bir veri depolama formatı kullanıyor, eski verileri yeni formata taşımak ister misiniz?',
  ...
  next: 'Sonraki',
  no_access_to_file: 'Dotfile dosyasına yazma izni yok.',
  no_record: 'Kayıt yok',
  ...
  system_dotfile: 'Sistem Dotfile',
  system_default_dotfile: 'Sistem Varsayılan Dotfile',
  system_default_config: 'Sistem Varsayılan Yapılandırması',
  system_dotfile_history: 'Sistem Dotfile geçmiş sürümleri',
  system_dotfile_history_delete_confirm: 'Bu öğeyi silmek istediğinizden emin misiniz?',
  system_dotfile_history_help: 'Toplam kayıt sayısı bu sınırları aşarsa, en eski kayıt silinecektir.',
  system_dotfile_history_limit: 'Maksimum kayıt sayısı: ',
  test: 'Test',
  theme: 'Tema',
  theme_dark: 'Karanlık',
  ...
  usage_data_help:
    "Anonim kullanım verilerini periyodik olarak göndererek SwitchDotfile'u iyileştirmemize yardımcı olmak ister misiniz?",
  usage_data_title: "SwitchDotfile'u Daha İyi Yapın!",
  ...
  where_is_my_dotfile: 'Dotfile dosyam nerede?',
  window: 'Pencere',
  write_mode: 'Yazma modu',
  write_mode_append_help: 'Yeni kayıtları sistem dotfile dosyasının sonuna ekleyin.',
  write_mode_overwrite_help: 'Yeni kayıtlarla sistem dotfile dosyasını üzerine yazın.',
  write_mode_set: 'Yazma modunu ayarla',
  your_data_is: 'Veri dosyalarınız şurada saklanıyor:',
  your_dotfile_is: 'Dotfile dosyanız şu konumda bulunuyor:',
  zoom: 'Yakınlaştır',
  zoom_in: 'Yakınlaştır',
  zoom_out: 'Uzaklaştır',
}
